...
def main():
    ...
    parser.add_argument("--dataset_path", type=str, default="D:/Deeplearning_code/yolov8/ultralytics/dataset/vis/output/val", help="YOLO数据集的根目录")
    parser.add_argument("--output", type=str, default="D:/Deeplearning_code/yolov8/detectron2/tools/datasets/coco/instances_val2017.json", help="输出的COCO格式JSON文件路径")
    parser.add_argument("--subset", type=str, default="D:/Deeplearning_code/yolov8/ultralytics/dataset/vis/output/val/image_paths.txt", help="可选，指定包含要处理的图像列表的文本文件路径")
